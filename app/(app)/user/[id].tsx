...
export default function UserProfileScreen() {
  ...
  return (
    ...
    >
        ...
        <TouchableOpacity
          onPress={() => {
            if (userProfile.image) {
              setFullscreenImage(userProfile.image);
            }
          }}
          activeOpacity={userProfile.image ? 0.85 : 1}
          className="w-28 h-28 rounded-full bg-secondary border-4 border-primary/40 items-center justify-center overflow-hidden mb-3 shadow-lg relative"
        >
          {userProfile.image ? (
            <Image
      ...
      {/* Модальне вікно перегляду аватара з зумом */}
      <ImageViewerModal
